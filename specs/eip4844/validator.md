...
and by extension the [Eip4844 consensus specs][eip4844-specs].
...
Refer to the [Eip4844 validator specs][eip4844-validator-specs] for the expected set of duties a validator is
...
2. Assemble a `BlindedBeaconBlock` according to the process outlined in the [Eip4844 specs][eip4844-specs] but with
...
[eip4844-specs]: https://github.com/ethereum/consensus-specs/blob/dev/specs/eip4844
[eip4844-validator-specs]: https://github.com/ethereum/consensus-specs/blob/dev/specs/eip4844/validator.md
